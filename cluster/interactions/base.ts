...
import { checkPermission, UserError } from '@clu/utils';
import { buildRuntimeErrorEmbed } from '@clu/utils/shard-specific';
import { t } from '@clu/managers/i18n/';
import { GuildSettingsStore } from '@clu/stores';

import app from '..';

export class BaseInteractionCommand extends Interaction.InteractionCommand<Interaction.ParsedArgs> {
...
export class BaseCommandOption extends Interaction.InteractionCommandOption<Interaction.ParsedArgs> {
...
export class BaseCommandOptionGroup extends Interaction.InteractionCommandOption<Interaction.ParsedArgs> {
  public type =
